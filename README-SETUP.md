...
- Học viên bắt buộc phải tick ô **"Chấp nhận cho Suleco sử dụng hình ảnh cho mục đích truyền thông"** mới đăng ký được; nội dung đồng ý này được lưu vào cột `DongYSuDungAnh` trong Sheet để đối chiếu sau này.
